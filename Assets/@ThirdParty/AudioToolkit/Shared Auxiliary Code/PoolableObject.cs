...
namespace CS.Essentials
{
    ...
    public class PoolableObject : MonoBehaviour
    {
        ...
        internal bool _handleAcivateMessagesInOnEnable = false;
        ...
        {
            if ( _handleAcivateMessagesInOnEnable )
            {
                HandleActivateMessages();
                _handleAcivateMessagesInOnEnable = false;
            }
        }
        ...
        internal void TakeFromPool( Transform parent, bool activateObject )
        {
            ...
            {
                _handleAcivateMessagesInOnEnable = true;
            }
        }

        internal void HandleActivateMessages()
        {
            if ( sendAwakeStartOnDestroyMessage )
            {
                ...
                {
                    _pool.CallMethodOnObject( gameObject, "Awake", true, sendAwakeToInactive, useReflectionInsteadOfMessages );
