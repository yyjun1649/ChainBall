...
namespace CS.Essentials
{
    ...
    static public class ObjectPoolController
    {
        ...
        static public GameObject MakePoolable(
            ...
            bool sendPoolableActivateDeactivateMessages = false,
            ...
            bool preloadImmediately = false )
        {
            ...
            poolableObject.sendPoolableActivateDeactivateMessages = sendPoolableActivateDeactivateMessages;
            poolableObject.useReflectionInsteadOfMessages = useReflectionInsteadOfMessages;
        ...
        static internal ObjectPool _GetPool( PoolableObject prefabPoolComponent )
        {
            ...
            if ( prefabPoolComponent._pool != null )
                prefab = prefabPoolComponent._pool.prefab.gameObject;
            else
