...
namespace CS.AudioToolkit
{
    static class UIUtility
    {
        ...
        {
#if UNITY_2021_3_OR_NEWER // Unity fixed the typo in 2021.3.14
            GUIStyle toolbarSearchFieldStyle = new GUIStyle( "ToolbarSearchTextField" );
            GUIStyle toolbarSearchFieldCancelButtonStyle = new GUIStyle( "ToolbarSearchCancelButton" );
            GUIStyle toolbarSearchFieldCancelButtonEmptyStyle = new GUIStyle( "ToolbarSearchCancelButtonEmpty" );
#else
