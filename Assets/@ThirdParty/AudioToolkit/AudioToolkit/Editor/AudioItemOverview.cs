...
namespace CS.AudioToolkit
{
    public class AudioItemOverview : EditorWindow
    {
        ...
        private void Initialise()
        {
            ...
            _listItemBackgroundNormal0 = UIUtility.MakeTex( 32, 32, gray );
            _listItemBackgroundNormal1 = UIUtility.MakeTex( 32, 32, lighterGray );
            _listItemBackgroundClicked = UIUtility.MakeTex( 32, 32, evenLighterGray );

            Color blue = new Color( 0f, 0f, 0.2f );
            Color lighterBlue = blue * 1.4f;
            _categoryBackgroundNormal = UIUtility.MakeTex( 32, 32, blue );
            _categoryBackgroundClicked = UIUtility.MakeTex( 32, 32, lighterBlue );
